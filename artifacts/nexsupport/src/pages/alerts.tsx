...
const SeverityBadge = ({ severity }: { severity: string }) => {
  switch (severity) {
    case 'critical': return <Badge variant="destructive" className="bg-destructive/20 text-destructive hover:bg-destructive/30 border-none">Critical</Badge>;
    case 'high': return <Badge variant="outline" className="bg-secondary/20 text-secondary hover:bg-secondary/30 border-none">High</Badge>;
    case 'medium': return <Badge variant="outline" className="bg-blue-500/20 text-blue-500 hover:bg-blue-500/30 border-none">Medium</Badge>;
    default: return <Badge variant="outline" className="bg-muted text-muted-foreground border-none">Info</Badge>;
  }
};
...
export function Alerts() {
  ...
  return (
    <div className="space-y-6 h-full flex flex-col animate-in fade-in duration-500">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-white">Alerts Center</h1>
        <p className="text-muted-foreground mt-1">System events requiring operator attention</p>
      </div>
        ...
        {isSummaryLoading ? (
          ...
          <>
            ...
            <Card className="border-secondary/50 bg-secondary/5 cursor-pointer hover:bg-secondary/10 transition-colors">
              <CardContent className="p-4 flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-secondary">High</p>
            ...
            <Card className="border-blue-500/50 bg-blue-500/5 cursor-pointer hover:bg-blue-500/10 transition-colors">
              <CardContent className="p-4 flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-blue-500">Medium</p>
